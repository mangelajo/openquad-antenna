...
const LANGS = {
  ...
  en: {
    ...
    "sec1.spacing-hint": `Affects boom length only — see <a href="${T_en}">TEORIA §1.5</a>.`,
  ...
  it: {
    ...
    "sec1.spacing-maxgain": "Max gain  (0.200 λ — ARRL/Orr)",
    "sec1.spacing-maxfb":   "Max F/B  (0.186 λ — W6SAI/YT1VP, +4.5 dB F/B)",
    "sec1.spacing-hint": `Incide solo sulla lunghezza del boom — vedi <a href="${T_it}">TEORIA §1.5</a>.`,
  ...
  pt: {
    ...
    "sec1.spacing-maxfb":   "Máx. F/B  (0.186 λ — W6SAI/YT1VP, +4.5 dB F/B)",
    "sec1.spacing-hint": `Afeta apenas o comprimento do boom — ver <a href="${T_pt}">TEORIA §1.5</a>.`,
  ...
  ja: {
    ...
    "sec1.spacing-mode": "間隔モード",
    "sec1.spacing-maxgain": "最大利得  (0.200 λ — ARRL/Orr)",
    "sec1.spacing-maxfb":   "最大 F/B  (0.186 λ — W6SAI/YT1VP, +4.5 dB F/B)",
    "sec1.spacing-hint": `ブーム長にのみ影響します — <a href="${T_ja}">TEORIA §1.5</a> を参照。`,
  ...
  zh: {
    ...
    "sec1.spacing-mode": "间距模式",
    "sec1.spacing-maxgain": "最大增益  (0.200 λ — ARRL/Orr)",
    "sec1.spacing-maxfb":   "最大 F/B  (0.186 λ — W6SAI/YT1VP, +4.5 dB F/B)",
    "sec1.spacing-hint": `仅影响主梁长度 —— 参见 <a href="${T_zh}">TEORIA §1.5</a>。`,
